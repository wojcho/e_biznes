...
import { githubOAuthStart } from "./oauth-github-start.ts";
import { githubOAuthCallback } from "./oauth-github-callback.ts";
...
publicRouter.get("/oauth/github", githubOAuthStart);
publicRouter.get("/oauth/github/callback", githubOAuthCallback);
